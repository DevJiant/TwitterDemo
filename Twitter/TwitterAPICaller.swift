...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "S2tEKUgaeBkUIuJneowUSsYk9", consumerSecret: "vAW52php3K2RRihNSYRbzpS8dibUtcA6LQGGO6f0r9MUCqkl3D")
    var loginSuccess: (() -> ())?
